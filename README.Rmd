...
The choice of reference period for the baseline has a considerable impact on the amount of  excess death. Most of the difference between baselines is driven by the 70-79 age group, except for the low rate of excess deaths found using the 2014-19 baseline -- a clear outlier -- which is driven by the 80-89 age group. Figure 13 explores the baselines for these two age groups. 
