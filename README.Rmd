...
In this analysis, I have examined the mortality rates in Denmark during the Covid-19 pandemic by quarter, age, and sex, and compared  the rates to pre-pandemic baseline rates using a very simple model. The simplicity allows for transparency into the model choices that impact how much excess mortality is measured during the pandemic. These choices include choice of the reference period, choice of stratification, and choice of threshold for normal variability. The sensitivity analysis is specific for this method and this dataset. Other methods or datasets may be more or less sensitive to e.g. baseline choice or stratification.
...
- Stratification matters somewhat.
- What is normal?
