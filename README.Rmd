...
In the following figures (Figure 6 and 7), I show the difference between the observed death rates and season adjusted baselines (here called $\Delta$death rates), in effect de-trending and de-seasonalizing the death rates and baselines.
...
preds_more <- 
  make_prediction(death_rates_10, "2008-19", 2008, 2019, z, Age, Sex) %>%
  bind_rows(make_prediction(death_rates_10, "2009-19", 2009, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_10, "2010-19", 2010, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_10, "2011-19", 2011, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_10, "2012-19", 2012, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_10, "2013-19", 2013, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_10, "2014-19", 2014, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_10, "2015-19", 2015, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_10, "2016-19", 2016, 2019, z, Age, Sex)) 
```
...
preds_more %>%
  ...
  geom_line(aes(YQ, excess_rate_sab * 1000), color = colors_2[2], size = .25) +
  scale_y_continuous(limits = c(NA, NA)) +
...
To explore how sensitive the result is to the choice of stratification, I first used 5-year instead of 10-year age bins. The de-trended and de-seasonalized death rates and baselines are shown in Figure 14 and 15. The calculated excess deaths for this stratification are shown in Figure 16. The numbers are lower than the numbers found using 10-year bins.
...
preds_5 <- 
  make_prediction(death_rates_5, "2008-19", 2008, 2019, z, Age, Sex) %>% 
  bind_rows(make_prediction(death_rates_5, "2009-19", 2009, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_5, "2010-19", 2010, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_5, "2011-19", 2011, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_5, "2012-19", 2012, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_5, "2013-19", 2013, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_5, "2014-19", 2014, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_5, "2015-19", 2015, 2019, z, Age, Sex)) %>%
  bind_rows(make_prediction(death_rates_5, "2016-19", 2016, 2019, z, Age, Sex))
```
...
Then, I tried other stratifications, namely 10- and 5-year age bins but without stratifying for sex, and a completely non-stratified dataset. The excess death rates for all baselines and stratifications are shown in Figure 17. To check how much of the differences are explained by calculating excess deaths as those exceeding an interval, 

*Should be edited: I also calculated excess deaths compared to the mean season adjusted baseline itself (Figure 18) and found a bit less impact of stratification. So the impact of stratification can be explained both by the prediction intervals and the baselines themselves* 
...
preds_no_strata <- 
  make_prediction(death_rates_ns, "2008-19", 2008, 2019, z) %>%
  bind_rows(make_prediction(death_rates_ns, "2009-19", 2009, 2019, z)) %>%
  bind_rows(make_prediction(death_rates_ns, "2010-19", 2010, 2019, z)) %>%
  bind_rows(make_prediction(death_rates_ns, "2011-19", 2011, 2019, z)) %>%
  bind_rows(make_prediction(death_rates_ns, "2012-19", 2012, 2019, z)) %>%
  bind_rows(make_prediction(death_rates_ns, "2013-19", 2013, 2019, z)) %>%
  bind_rows(make_prediction(death_rates_ns, "2014-19", 2014, 2019, z)) %>%
  bind_rows(make_prediction(death_rates_ns, "2015-19", 2015, 2019, z)) %>%
  bind_rows(make_prediction(death_rates_ns, "2016-19", 2016, 2019, z)) 
```
...
preds_5_no_sex <- 
  make_prediction(death_rates_5a, "2008-19", 2008, 2019, z, Age) %>% 
  bind_rows(make_prediction(death_rates_5a, "2009-19", 2009, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_5a, "2010-19", 2010, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_5a, "2011-19", 2011, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_5a, "2012-19", 2012, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_5a, "2013-19", 2013, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_5a, "2014-19", 2014, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_5a, "2015-19", 2015, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_5a, "2016-19", 2016, 2019, z, Age))

preds_10_no_sex <- 
  make_prediction(death_rates_10a, "2008-19", 2008, 2019, z, Age) %>% 
  bind_rows(make_prediction(death_rates_10a, "2009-19", 2009, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_10a, "2010-19", 2010, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_10a, "2011-19", 2011, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_10a, "2012-19", 2012, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_10a, "2013-19", 2013, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_10a, "2014-19", 2014, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_10a, "2015-19", 2015, 2019, z, Age)) %>%
  bind_rows(make_prediction(death_rates_10a, "2016-19", 2016, 2019, z, Age))
```
...
In this analysis, I have examined the mortality rates in Denmark during the Covid-19 pandemic by quarter, age, and sex, and compared  the rates to pre-pandemic baseline rates using a very simple model. The simplicity of the model allows for transparency into the choices that impact how much excess mortality is observed during the pandemic. These choices include choice of the reference period, choice of stratification, and choice of threshold for normal variability. The sensitivity analysis is specific for this method and this dataset. Other methods or datasets may be more or less sensitive to e.g. baseline choice or stratification.
