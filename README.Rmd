...
preds %>%
  ...
  geom_vline(xintercept = 2019.88, size = 0.4, color = "gray70") +
  geom_line(aes(YQ, Death_rate * 1000, color = Sex), size = .4) +
  gglayer_1 +
