...
I calculated death rates for each age and sex group using 10-year bins. The death rate is here defined as the number of deaths for a given quarter (shown below in panel A and B) divided by the population size at the start of the quarter (panel C). 
