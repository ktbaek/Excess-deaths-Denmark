...
-   Stratification matters somewhat. Using 5-year bins results in less
    excess death compare to using 10-year bins. Stratifying for sex does
    not make a huge difference.

-   What is normal?

-   Excess deaths by quarter (or shorter intervals) may give a different
    estimation of excess deaths when cumulating over longer time
    periods, than calculating using longer periods (e.g. one or more
    years). I have not explored that.
